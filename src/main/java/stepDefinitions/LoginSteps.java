...
public class LoginSteps extends DriverFactory {
    ...
    public void user_enters_the_something_username(String username, String strArg1) throws Throwable {
        throw new PendingException();
    }

    @And("^user enter the \"([^\"]*)\" password$")
    public void user_enter_the_something_password(String password, String strArg1) throws Throwable {
        throw new PendingException();
    }
