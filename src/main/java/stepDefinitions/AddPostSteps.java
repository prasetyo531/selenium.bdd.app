...
public class AddPostSteps extends DriverFactory {
    ...
    public void user_clicks_add_post_from_tab_post_profile() {
    ...
    public void user_clicks_add_post_from_homescreen_menu() {
    ...
    public void user_will_see_new_post_and_button_to_add_post_dissapear() {
       profileScreen.isButtonAddPostReviewDissappear();
    }
}
